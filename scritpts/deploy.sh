...
//если меняли какие-то сущности на сервере без миграции
mysql -h sweater-london-db.ch3h0bxmpfno.eu-west-2.rds.amazonaws.com -u admin -p 13572468 << EOF
drop TABLE IF EXISTS `sweater`.`spring_session_attributes`;
